      ...
      <div className="space-y-8 text-center">
        <div className="space-y-2">
          ...
          <p className="mx-auto text-13 text-secondary md:w-1/2">
            That crashed IMT, pun intended. No worries, though. Our engineers have been notified. If you have more
            details, please write to{" "}
            <a href="mailto:support@imt.local" className="text-accent-primary">
              support@imt.local
            </a>{" "}
