    ...
    <PageWrapper
      customHeader={
        <AuthenticationMethodCard
          name="GitHub"
          description="Allow members to login or sign up to IMT with their GitHub accounts."
          icon={
            <img
...
export const meta: Route.MetaFunction = () => [{ title: "GitHub Authentication - Instance Admin" }];
