    ...
    <PageWrapper
      customHeader={
        <AuthenticationMethodCard
          name="GitLab"
          description="Allow members to login or sign up to IMT with their GitLab accounts."
...
export const meta: Route.MetaFunction = () => [{ title: "GitLab Authentication - Instance Admin" }];
