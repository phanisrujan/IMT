  ...
  return (
    <PageWrapper
      header={{
        ...
        description: (
          <>
            IMT can send useful emails to you and your users from your own instance without talking to the Internet.
...
export const meta: Route.MetaFunction = () => [{ title: "Email Settings - Instance Admin" }];
