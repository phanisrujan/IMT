        ...
        {invitationDetail && !invitationDetail.responded_at ? (
          error ? (
            ...
            <EmptySpace
              ...
              description="Your workspace is where you'll create projects, collaborate on your work items, and organize different streams of work in your IMT account."
            >
          ...
          invitationDetail?.accepted ? (
            ...
            >
              ...
              <EmptySpaceItem Icon={Star} title="Star us on GitHub" href="https://github.com/phanisrujan/IMT" />
              <EmptySpaceItem
                Icon={Share2}
                title="Join our community of active creators"
                href="https://github.com/phanisrujan/IMT/discussions"
              />
            </EmptySpace>
          )
        ) : (
