...
export const meta = () => [
  { title: "IMT | Issue management for modern teams." },
  ...
  { property: "og:image:alt", content: "IMT - Issue management for modern teams" },
  { name: "twitter:site", content: "@IMT" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: "https://github.com/phanisrujan/IMT" },
  { name: "twitter:image:width", content: "1200" },
  { name: "twitter:image:height", content: "630" },
  { name: "twitter:image:alt", content: "IMT - Issue management for modern teams" },
];
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="IMT" />
