    ...
    await transferIssuesFromCycle(workspaceSlug.toString(), projectId.toString(), cycleId.toString(), payload)
      .then(async () => {
        setToast({
          ...
          title: "Success!",
          message: "Tickets have been transferred successfully",
        });
      ...
      .catch(() => {
        setToast({
          ...
          title: "Error!",
          message: "Unable to transfer tickets. Please try again.",
        });
      });
  };
      ...
      <div className="flex flex-col gap-4 py-5">
        <div className="flex items-center justify-between px-5">
          <div className="flex items-center gap-1">
            ...
            <h4 className="text-18 font-medium text-primary">Transfer tickets</h4>
          </div>
            ...
            filteredOptions.length > 0 ? (
              ...
              <div className="flex w-full items-center justify-center gap-4 p-5 text-13">
                ...
                <span className="text-center text-secondary">
                  You don’t have any current cycle. Please create one to transfer the tickets.
                </span>
              </div>
            )
          ) : (
