...
export const usePowerKHelpCommands = (): TPowerKCommandConfig[] => {
  ...
  return [
    ...
    },
    {
      ...
      icon: FileText,
      action: () => {
        window.open("https://github.com/phanisrujan/IMT#readme", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
    },
    {
      ...
      icon: MessageSquare,
      action: () => {
        window.open("https://github.com/phanisrujan/IMT/discussions", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
    },
    {
      ...
      icon: GithubIcon,
      action: () => {
        window.open("https://github.com/phanisrujan/IMT/issues/new/choose", "_blank", "noopener,noreferrer");
      },
      isEnabled: () => true,
      isVisible: () => true,
      closeOnSelect: true,
