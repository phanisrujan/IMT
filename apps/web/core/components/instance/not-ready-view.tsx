    ...
    <div className="relative">
      <div className="flex h-screen w-full flex-col overflow-hidden overflow-y-auto">
        ...
        <div className="absolute inset-0 z-0">
          <img src={patternBackground} className="h-full w-full object-cover" alt="IMT background pattern" />
        </div>
          ...
          <div className="relative container mx-auto flex h-full w-full items-center justify-center px-5">
            <div className="relative w-auto max-w-2xl space-y-8 py-10">
              <div className="relative flex flex-col items-center justify-center space-y-4">
                <h1 className="pb-3 text-24 font-bold">Welcome aboard IMT!</h1>
                <img src={PlaneTakeOffImage} className="h-full w-full object-cover" alt="IMT Logo" />
