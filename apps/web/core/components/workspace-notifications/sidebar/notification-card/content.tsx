...
export const BASE_NOTIFICATION_CONTENT_MAP: TNotificationContentMap = {
  duplicate: ({ verb }) => ({
    action:
      verb === "created"
        ? "marked that this ticket is a duplicate of"
        : "marked that this ticket is not a duplicate",
    value: null,
    showConnector: false,
  }),
  ...
  relates_to: () => ({
    action: "marked that this ticket is related to",
    value: null,
    showConnector: true,
  }),
  ...
  archived_at: ({ newValue }) => ({
    action: newValue === "restore" ? "restored the ticket" : "archived the ticket",
    value: null,
    showConnector: false,
  }),
  None: () => ({
    action: null,
    value: "the ticket and assigned it to you.",
    showConnector: false,
  }),
