  ...
  return (
    <>
      ...
      <CustomMenu
        ...
        closeOnSelect
      >
        <CustomMenu.MenuItem onClick={() => window.open("https://github.com/phanisrujan/IMT#readme", "_blank")}>
        ...
        <CustomMenu.MenuItem onClick={() => window.open("mailto:sales@imt.local", "_blank")}>
          <div className="flex items-center gap-x-2 rounded-sm text-11">
        ...
        <CustomMenu.MenuItem onClick={() => window.open("https://github.com/phanisrujan/IMT/discussions", "_blank", "noopener,noreferrer")}>
          <div className="flex items-center gap-x-2 rounded-sm text-11">
