...
const integrationDetails: { [key: string]: any } = {
  github: {
    ...
    notInstalled: "Connect with GitHub with your IMT workspace to sync project tickets.",
  },
  slack: {
    logo: SlackLogo,
    installed: "Activate Slack on individual projects to sync with specific channels.",
    notInstalled: "Connect with Slack with your IMT workspace to sync project tickets.",
  },
};
