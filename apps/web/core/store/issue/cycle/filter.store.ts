...
export class CycleIssuesFilter extends IssueFilterHelperStore implements ICycleIssuesFilter {
  ...
  /**
   * NOTE: This method is designed as a fallback function for the ticket filter store.
   * Only use this method directly when initializing filter instances.
   * For regular filter updates, use this method as a fallback function for the ticket filter store methods instead.
   */
