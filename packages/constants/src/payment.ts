...
import { WEBSITE_URL } from "./endpoints";
...
export const PLANE_COMMUNITY_PRODUCTS: Record<string, IPaymentProduct> = {
  ...
  [EProductSubscriptionEnum.BUSINESS]: {
    ...
    name: "IMT Business",
    description:
      "Business plan packaging with annual or monthly billing for IMT Cloud.",
    type: "BUSINESS",
    prices: [
      {
 ...
 */
export const TALK_TO_SALES_URL = WEBSITE_URL;
...
export const SUBSCRIPTION_WEBPAGE_URLS: Record<EProductSubscriptionEnum, string> = {
  ...
  [EProductSubscriptionEnum.PRO]: WEBSITE_URL,
  [EProductSubscriptionEnum.BUSINESS]: WEBSITE_URL,
  [EProductSubscriptionEnum.ENTERPRISE]: WEBSITE_URL,
};
