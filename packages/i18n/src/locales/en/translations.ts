  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Welcome to IMT, we are excited to have you here. Create your first project and track your work items, and this page will transform into a space that helps you progress. Admins will also see items which help their team progress.",
        primary_button: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Get started by creating a new work item! Add details and properties to it. Explore more in IMT to see your activity.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "IMT will auto archive work items that have been completed or canceled.",
        duration: "Auto-archive work items that are closed for",
      },
      "auto-close": {
        title: "Auto-close work items",
        description: "IMT will automatically close work items that haven't been completed or canceled.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Work items are building blocks in IMT.",
            description:
              "Redesign the IMT UI, Rebrand the company, or Launch the new fuel injection system are examples of work items that likely have sub-work items.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        ...
        description:
          "Pages are thoughts potting space in IMT. Take down meeting notes, format them easily, embed work items, lay them out using a library of components, and keep them all in your project's context. To make short work of any doc, invoke Galileo, IMT's AI, with a shortcut or the click of a button.",
        primary_button: {
