...
export default {
  ...
  state_change_description: "Notify me when tickets move to a different status",
  ...
  active_cycles_description:
    "Monitor sprints across projects, track high-priority tickets, and zoom in on sprints that need attention.",
  on_demand_snapshots_of_all_your_cycles: "On-demand snapshots of all your sprints",
  upgrade: "Upgrade",
  "10000_feet_view": "10,000-feet view of all active sprints.",
  ...
  get_snapshot_of_each_active_cycle: "Get a snapshot of each active sprint.",
  get_snapshot_of_each_active_cycle_description:
    "Track high-level metrics for all active sprints, see their progress status, and get a sense of scope against deadlines.",
  compare_burndowns: "Compare burndowns.",
  compare_burndowns_description:
    "Monitor how each of your teams are performing with a peek into each sprint's burndown report.",
  quickly_see_make_or_break_issues: "Quickly see make-or-break tickets.",
  quickly_see_make_or_break_issues_description:
    "Preview high-priority tickets for each sprint against due dates. See all of them per sprint in one click.",
  zoom_into_cycles_that_need_attention: "Zoom into sprints that need attention.",
  zoom_into_cycles_that_need_attention_description:
    "Investigate the status of any sprint that doesn't conform to expectations in one click.",
  ...
  support: "Support",
  forum: "Forum",
  powered_by_plane_pages: "Powered by IMT Pages",
  ...
  update: "Update",
  updating: "Updating",
  create_new_issue: "Create new ticket",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Most things start with a project in IMT.",
        cta: "Get started",
      },
      invite_team: {
  ...
  issue: {
    ...
    add: {
      ...
      label: "Add ticket",
      cycle: {
        failed: "Ticket could not be added to the sprint. Please try again.",
        success: "{count, plural, one {Ticket} other {Tickets}} added to the sprint successfully.",
        loading: "Adding {count, plural, one {ticket} other {tickets}} to the sprint",
      },
    ...
    remove: {
      label: "Remove ticket",
      cycle: {
        loading: "Removing ticket from the sprint",
        success: "Ticket removed from the sprint successfully.",
  ...
  inbox_issue: {
    ...
    empty_state: {
      sidebar_open_tab: {
        ...
        description: "Find open tickets here. Create new ticket.",
      },
      sidebar_closed_tab: {
      ...
      sidebar_filter: {
        ...
        description: "No ticket matches filter applied in intake. Create a new ticket.",
      },
      detail: {
  ...
  workspace_creation: {
    ...
    subheading: "To start using IMT, you need to create or join a workspace.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Welcome to IMT, we are excited to have you here. Create your first project and track your tickets, and this page will transform into a space that helps you progress. Admins will also see items which help their team progress.",
        primary_button: {
          text: "Build your first project",
          comic: {
            title: "Everything starts with a project in IMT",
  ...
  workspace_analytics: {
    ...
    backlog_work_items: "Validation {entity}",
    ...
    empty_state: {
      project_insights: {
        title: "No data yet",
        description: "Tickets assigned to you, broken down by status, will show up here.",
      },
      created_vs_resolved: {
        title: "No data yet",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copy and save this secret key in IMT Pages. You can't see this key after you hit Close. A CSV file containing the key has been downloaded.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Any application using this token will no longer have the access to IMT data. This action cannot be undone.",
          success: {
            title: "Success!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "IMT APIs can be used to integrate your data in IMT with any external system. Create a token to get started.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Get started by creating a new ticket! Add details and properties to it. Explore more in IMT to see your activity.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    states: {
      heading: "Status",
      description: "Define and customize workflow statuses to track the progress of your tickets.",
      describe_this_state_for_your_members: "Describe this status for your members.",
      empty_state: {
        title: "No statuses available for the {groupKey} group",
        description: "Please create a new status",
      },
    },
    labels: {
      heading: "Labels",
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "IMT will auto archive tickets that have been completed or canceled.",
        duration: "Auto-archive tickets that are closed for",
      },
      "auto-close": {
        title: "Auto-close tickets",
        description: "IMT will automatically close tickets that haven't been completed or canceled.",
  ...
  project_cycles: {
    ...
    action: {
      ...
      update: {
        ...
        error: {
          already_exists:
            "You already have a sprint on the given dates. If you want to create a draft sprint, remove both dates.",
        },
      },
    },
    empty_state: {
      general: {
        ...
        primary_button: {
          ...
          comic: {
            ...
            description:
              "A sprint, iteration, or any term you use for weekly or fortnightly tracking can be configured here.",
          },
        },
      },
      no_issues: {
        title: "No tickets added to the sprint",
        description: "Add or create tickets you want to timebox and deliver within this sprint.",
        primary_button: {
          text: "Create new ticket",
        },
        secondary_button: {
      ...
      completed_no_issues: {
        title: "No tickets in the sprint",
        description:
          "No tickets in the sprint. Tickets are either transferred or hidden. To see hidden tickets, update your display properties.",
      },
      active: {
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Tickets are building blocks in IMT.",
            description:
              "Redesign the IMT UI, Rebrand the company, or Launch the new fuel injection system are examples of tickets that likely have sub-tickets.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Write a note, a doc, or a full knowledge base. Get Galileo, IMT's AI assistant, to help you get started",
        description:
          "Pages are thoughts potting space in IMT. Take down meeting notes, format them easily, embed tickets, lay them out using a library of components, and keep them all in your project's context. To make short work of any doc, invoke Galileo, IMT's AI, with a shortcut or the click of a button.",
        primary_button: {
  ...
  active_cycle: {
    empty_state: {
      progress: {
        title: "Add tickets to the sprint to view it's progress",
      },
      chart: {
        title: "Add tickets to the sprint to view the burndown chart.",
      },
      priority_issue: {
        title: "Observe high priority tickets tackled in the sprint at a glance.",
      },
      assignee: {
  ...
  disabled_project: {
    empty_state: {
      ...
      cycle: {
        title: "Sprints are not enabled for this project.",
        description:
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "IMT didn't start up. This could be because one or more IMT services failed to start.",
  ...
  power_k: {
    ...
    help_actions: {
      ...
      open_plane_documentation: "Open IMT documentation",
